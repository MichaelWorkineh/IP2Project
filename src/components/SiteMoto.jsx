    ...
    <div className='justify-center relative'>
      <div className='flex items-center relative'>
        ...
        <div key={currMotive.id} className='border border-white-700 shadow-custom'>
          ...
          <div onClick={nextSlide} className='absolute top-1/2 right-4 transform -translate-y-1/2 cursor-pointer text-orange--500 text-6xl z-999 rounded-full bg-gray-500 p-2'>
