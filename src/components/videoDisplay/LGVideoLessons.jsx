...
const Destinycard = ({ courses, courseInfo }) => {
...
function ItemGroup({ group, hoveredIndex, setHoveredIndex, addToCart, addToWishlist, courseInfo }) {
  return (
...
function Item({ course, index, hoveredIndex, setHoveredIndex, addToCart, addToWishlist, courseInfo }) {
